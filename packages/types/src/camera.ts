...
export const cameraSchema = z.object({
  ...
  source_codec: z.string().nullable().optional(),
  source_resolution: z.string().nullable().optional(),
  source_fps: z.number().int().nullable().optional(),
  source_audio: z.string().nullable().optional(),
