export default function ApiReferencePage() {
  const endpoints = [
    ...
    { method: "POST", path: "/api/v1/ai-integrations", desc: "Create AI integration" },
    { method: "GET", path: "/api/v1/ai-integrations", desc: "List AI integrations" },
    { method: "DELETE", path: "/api/v1/ai-integrations/:id", desc: "Delete AI integration" },
    { method: "GET", path: "/api/v1/ai-integrations/events", desc: "List AI events" },
